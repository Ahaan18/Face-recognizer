...
t = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/KzVJ8MElW/model.json', model);
function model(){
...
if(e){
    ...
    document.getElementById("accuracy").innerHTML = r[0].confidence.toFixed(2)*100+"%";
}
}